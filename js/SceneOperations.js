...
function createTestSceneElements() {
    ...
    // for (let i = 0; i < 100; i++) {
    //     let houseObject = new Objects.House(new THREE.Vector3((Math.random() - 0.5) * parameters.plane.scale, 0, (Math.random() - 0.5) * parameters.plane.scale), new THREE.Vector3(0, 0), Materials.treeMaterial);
